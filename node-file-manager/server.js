...
// Bootstrap models
require("./server/appManager/models/appBundle");
require("./server/appManager/models/appBundle-version");
require("./server/users/models/user");

//Handlers for routes
require("./server/appManager/routes/appRoutes")(app,config,cache);
require("./server/login/routes/loginRoutes")(app,config,cache);
require("./server/users/routes/userRoutes")(app,config,cache);
